...
public class ParserTest {
    ...
    public void parserTest_wrongDescriptionFormat_throwException() {
        HakunaMatataException actualExceptionDeadlineMissingName = Assertions.assertThrows(HakunaMatataException.class, () -> {
        ...
        HakunaMatataException actualExceptionDeadlineMissingBy = Assertions.assertThrows(HakunaMatataException.class, () -> {
        ...
        HakunaMatataException actualExceptionDeadlineMissingDateTime = Assertions.assertThrows(HakunaMatataException.class, () -> {
        ...
        HakunaMatataException actualExceptionEventMissingName = Assertions.assertThrows(HakunaMatataException.class, () -> {
        ...
        HakunaMatataException actualExceptionEventMissingAt = Assertions.assertThrows(HakunaMatataException.class, () -> {
        ...
        HakunaMatataException actualExceptionEventMissingDateTime = Assertions.assertThrows(HakunaMatataException.class, () -> {
    ...
    public void parserTest_wrongDateTimeFormat_throwException() {
        HakunaMatataException actualExceptionDeadlineWrongDateTimeFormat = Assertions.assertThrows(HakunaMatataException.class, () -> {
