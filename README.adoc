...
image::delete_demo.gif[width="400"]
...
image::sort_deadline_demo.gif[width="400"]

image::sort_description_demo.gif[width="400"]
...
image::bye_demo.gif[width="400", title="bye demo"]
